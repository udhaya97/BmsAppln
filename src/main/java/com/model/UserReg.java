...
public class UserReg {
	...
	private String uName;
	  ...
	  @NotNull
	 @Size(min=5,message="password length should be 5 to 20")
	...
	@Email
	  @Pattern(regexp=".+@.+\\..+", message="enter correct email")
	...
	@NotNull
	@Size(min=4,max=6,message="enter the role Admin or User")
	private String role;
	...
	public UserReg(int uId, String uName, String pass, String dob,  String mailId, long mobileNo,
			String role) {
		super();
		this.uId = uId;
		this.uName = uName;
